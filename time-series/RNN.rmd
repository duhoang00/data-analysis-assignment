...
trainpred = predict(model,x_train, batch_size=1)
trainpred = invert_scaling(trainpred, Scaled$scaler,c(-1, 1))
testpred = predict(model,x_test, batch_size=1)
testpred = invert_scaling(testpred, Scaled$scaler,c(-1, 1))

plot(data$Passengers,type="line", col="blue")
lines(trainpred,col="green")
lines(testpred,col="red")

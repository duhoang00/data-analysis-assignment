...
# - Load Data
ads <- read.csv("./logistic-regression/multiple/advertising.csv")
head(ads)
...
# - CreateModel
model <- glm(Clicked.on.Ad ~ Daily.Time.Spent.on.Site + Age + Area.Income + Daily.Internet.Usage + Male, data = train,  family = binomial)
summary(model)
